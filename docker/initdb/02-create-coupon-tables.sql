...
-- 생일 쿠폰 템플릿 생성 (template_type_id = 1)
INSERT INTO CouponTemplate (template_type_id, state, template_name, discount_amount, min_order_amount, valid_days)
VALUES (1, 1, '생일 축하 쿠폰', 5000.00, 20000.00, 30);

-- 테스트용 회원 데이터 (이번 달 생일자들)
INSERT INTO Member (member_birth, member_name, member_email)
VALUES
